    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Cis\CelebrityModel\Celebrity */
        ...
        $form->setHtmlIdPrefix('celebrity_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_celebrity_edit_tab_content_prepare_form', ['form' => $form]);

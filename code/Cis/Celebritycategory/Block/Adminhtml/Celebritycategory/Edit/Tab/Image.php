    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'celebritycategory_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_celebritycategory_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Cis\Celebritycategory\Block\Adminhtml\Form\Element\Image'];
    }
}

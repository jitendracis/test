...
/**
 * Celebritycategory data helper
 */
namespace Cis\Celebritycategory\Helper;
...
{
    /**
     * Path to store config where count of celebritycategory posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'celebritycategory/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'Celebritycategory';
    ...
    /**
     * Remove Celebritycategory item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cis\Celebritycategory\Model\Celebritycategory $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Celebritycategory Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Celebritycategory Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCelebritycategoryPerPage()
    {

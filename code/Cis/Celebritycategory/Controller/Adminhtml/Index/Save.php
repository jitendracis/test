...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (isset($data['categoryParentId'])) {
                $categoryChild = $data['categoryParentId'];
                //unset($data['image']);
            }
           //$model->setData($data);
            ...
            if (!$this->dataProcessor->validate($data)) {
                $this->_redirect('*/*/edit', ['celebritycategory_id' => $model->getId(), '_current' => true]);
                return;
            }

            try {
                $imageHelper = $this->_objectManager->get('Cis\Celebritycategory\Helper\Data');
            ...
            $this->_redirect('*/*/edit', ['celebritycategory_id' => $this->getRequest()->getParam('celebritycategory_id')]);
            return;
        }
        $this->_redirect('*/*/');
    }

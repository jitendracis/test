...
class Save extends \Cisin\Enquiryform\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('cisin_enquiryform/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('cisin_enquiryform/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('cisin_enquiryform/*/new');
                }
                return;
            } catch (\Exception $e) {

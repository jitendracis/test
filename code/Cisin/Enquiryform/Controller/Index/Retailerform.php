...
class Retailerform extends \Magento\Framework\App\Action\Action {
		                      ...
		                      $email     = $post["email"];
								...
								try {
										...
										$transport = $this->_transportBuilder
													      ->setTemplateIdentifier('send_email_email_template_reatiler') // this code we have mentioned in the email_templates.xml
													      ->setTemplateOptions(
													[
										...
										$this->messageManager->addSuccess(__('Thankyou for contacting us '));
										$this->_redirect('*/*/');
										return;
										}
							catch (\Exception $e) {

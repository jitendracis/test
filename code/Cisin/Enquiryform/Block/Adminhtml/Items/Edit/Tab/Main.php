...
namespace Cisin\Enquiryform\Block\Adminhtml\Items\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_cisin_enquiryform_items');
        ...
        $fieldset->addField(
         ...
         $fieldset->addField(
            'product_name',
            'text',
            ['name' => 'product_name', 'label' => __('Product Name'), 'title' => __('Product Name')]
        );
          $fieldset->addField(
            'qty',
            'text',
            ['name' => 'qty', 'label' => __('Quantity'), 'title' => __('Quantity')]
        );
         $fieldset->addField(
            'job',
            'text',
